...
class Offer extends React.Component {
    ...
    getColumnsForProduct(product) {
        ...
        scope.forEach(s => {
            ...
            columns.push(<td className="red">${numeral(this.state.entry.fields.offer.fields.discount).format('0.00')}</td>);
            columns.push(<td><strong>${numeral(Math.max(s.fields.basePrice - this.state.entry.fields.offer.fields.discount, 0)).format('0.00')}</strong></td>);
        })
